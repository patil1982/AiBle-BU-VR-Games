...
public class ScreenShotHelper : MonoBehaviour {
    ...
    public void TakeScreenShot()
    {
        ...
        screenShotCam.farClipPlane = 1000f;
    ...
    public Texture2D PositionCamAndGetScreenTexture(Camera screenShotCam,int sqr = 50)
    {
        ...
        var maxZoomIn = distance * 3f;
        var maxZoomOut = distance * 1f;

        Vector3 posVector = new Vector3(-0.005f, -.1f,  -.1f)* (maxZoomIn + maxZoomOut);

        //Vector3 posVector = new Vector3(0f, -.1f, -.1f);

        Quaternion cameraRot = Quaternion.Euler(45, -180f, 0f);
