    ...
    public class ExoSimulatorInput2VR : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (deltaTime >= interval)
            {
                ...
                //if (m_objTrans1)
                //{
                //    m_ObjectTransfrom.position = m_JointTransfrom[3].position;
                ...
                //    //if (m_JointTransfrom[2].position == HomePosition)
                //    {
                ...
                if (FirstTime)
                {
                    Debug.Log("Catch Fruit");

                    nextPosition =Fruit.transform.position;
